              ...
              <div className="pt-12">
                ...
                <div className="flex justify-around mt-4">
                  <button
                    ...
                    className="bg-primary text-white px-4 py-2 rounded-md shadow-md hover:bg-blue-700 transition-colors flex items-center"
                  >
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-end space-x-4 mt-4">
              ...
              <button
                ...
                className="bg-primary text-white px-4 py-2 rounded-md shadow-md hover:bg-blue-700 transition-colors"
              >
                Save Changes
              </button>
            </div>
